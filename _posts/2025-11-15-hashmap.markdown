...
The array length is usually a power of two: </br>
8, 16, 32, 64, … </br>
...
>**No memory** access has happened yet.</br>
...
Assume key always string and value always int. </br>
